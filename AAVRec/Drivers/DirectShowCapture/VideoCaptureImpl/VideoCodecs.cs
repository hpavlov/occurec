...
namespace OccuRec.Drivers.DirectShowCapture.VideoCaptureImpl
{
	...
	public enum SupportedCodec
	{
        ...
        [DsDeviceName("Lagarith Lossless Codec", "LAGS")]
		Lagarith,
	...
	{
		private SupportedCodec codec = SupportedCodec.Uncompressed;
	...
	public static class VideoCodecs
	{
		...
		public static SystemCodecEntry GetSupportedVideoCodec(string codecName)
		{
			...
			SystemCodecEntry rv = supportedCodecs.SingleOrDefault(x => x.DeviceName == codecName && x.IsInstalled);
