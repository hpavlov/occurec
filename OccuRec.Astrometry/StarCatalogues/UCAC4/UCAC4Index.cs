...
namespace OccuRec.Astrometry.StarCatalogues.UCAC4
{
    ...
    internal class UCAC4Index
    {
        ...
        private UCAC4Index(string catalogLocation)
        {
			...
			int idx = -1;
			using (Stream data = AssemblyHelper.GetEmbededResourceStreamThatClientMustDispose("OccuRec.Astrometry.StarCatalogues.UCAC4", "ucac4.idx"))
			{
