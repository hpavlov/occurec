...
namespace OccuRec.FieldIdentification.UCAC2
{
    ...
    public class UCAC2Index
    {
        ...
        private UCAC2Index(string ucac2Folder)
        {
            ...
            int idx = -1;
            using (Stream data = AssemblyHelper.GetEmbededResourceStreamThatClientMustDispose("OccuRec.FieldIdentification.UCAC2", "ucac2.idx"))
            {
            ...
            idx = -1;
            using (Stream data = AssemblyHelper.GetEmbededResourceStreamThatClientMustDispose("OccuRec.FieldIdentification.UCAC2", "bss2.idx"))
            {
                BinaryReader rdr = new BinaryReader(data);
            ...
            using (Stream data = AssemblyHelper.GetEmbededResourceStreamThatClientMustDispose("OccuRec.FieldIdentification.UCAC2", "bsindex.da"))
            {
