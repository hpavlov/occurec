...
namespace OccuRec.FieldIdentification.UCAC3
{
    ...
    internal class UCAC3Index
    {
        ...
        private UCAC3Index(string catalogLocation)
        {
            ...
            int idx = -1;
            using (Stream data = AssemblyHelper.GetEmbededResourceStreamThatClientMustDispose("OccuRec.FieldIdentification.UCAC3", "ucac3.idx"))
            {
