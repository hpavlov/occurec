...
namespace OccuRec.Helpers
{
	public class AssemblyHelper
	{
		...
		//public static Stream GetEmbededResourceStreamThatClientMustDispose(Assembly assembly, string nameSpace, string fileNameOnly)
		//{
		//    return GetEmbededResourceStreamThatClientMustDispose(assembly, nameSpace, fileNameOnly);
		//}
		...
		public static Stream GetEmbededResourceStreamThatClientMustDispose(Assembly callingAssembly, string nameSpace, string fileNameOnly)
		{
