		...
		public bool Calibrate()
		{
			...
			if (signaturesRatio.Count > 0)
			{
                ...
                if (calibrationIsSuccessul)
                {
                    ...
                    NativeHelpers.ReconfigureIntegrationDetection((float)Settings.Default.MinSignatureDiffRatio, (float)Settings.Default.MinSignatureDiff, (float)Settings.Default.GammaDiff, Settings.Default.ForceNewFrameOnLockedRate);
